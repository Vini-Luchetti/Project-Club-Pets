...
Bem-vindo ao **Clube do Corvo**, um portal místico desenvolvido para a exploração e adoção de criaturas fantásticas. Este projeto combina o estilo *creepy-cute* (vibe Tim Burton) com interatividade web moderna.<br>Criado totalmente por IA (Gemini) com proposta de controle parental em 12 anos.<br>A proposta foi criar algo para interagir com progamação básica de HMTL e contato com a IA.<br>É recomendado que sempre tenha um responsável acompanhando.
...
## 🕸️ Sobre o Projeto
O Clube do Corvo é uma aplicação web interativa onde o usuário (Guardião) pode:
- Realizar um **Quiz de Personalidade** para descobrir sua afinidade mágica.
- Utilizar o **Caldeirão Místico** para criar poções e invocar pets personalizados.
